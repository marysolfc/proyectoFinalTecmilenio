...
if(!user){ // si no lo encuentra, le manda 3 parámetros en el callback done, 
...
}else{ // si si existe el usuario se comprueba la contraseña
    const match = await user.matchPassword(password);
    if(match){ // si coinciden las contraseñas, regresa, null porque no encontró error y el user que sí encontró

...
router.get("/notes", async (req, res) => {
  ...
  const notes = await Note.find().lean().sort({date:'desc'}); // trae todos los documentos de la colección Notes, se agrega lean() porque había un error al mostrarlo en la vista
...
router.delete('/notes/delete/:id',async (req,res) =>{ // se define la ruta
